...
lsp_zero.on_attach(function(client, bufnr)
    vim.keymap.set("n", "K", function() vim.lsp.buf.hover { border = "single" } end, { buffer = bufnr, desc = "Hover" })
    ...
    vim.keymap.set("n", "<leader>vws", function() vim.lsp.buf.workspace_symbol() end,
        { buffer = bufnr, desc = "View workspace symbol" })
    vim.keymap.set("n", "<leader>vdd", function() vim.diagnostic.open_float() end,
        { buffer = bufnr, desc = "View diagnostic" })
    vim.keymap.set("n", "<leader>vdn", function() vim.diagnostic.goto_next() end,
        { buffer = bufnr, desc = "View next diagnostic" })
    vim.keymap.set("n", "<leader>vdN", function() vim.diagnostic.goto_prev() end,
        { buffer = bufnr, desc = "View previous diagnostic" })
    vim.keymap.set("n", "<leader>vrr", function() vim.lsp.buf.references() end,
        { buffer = bufnr, desc = "Show all references" })
