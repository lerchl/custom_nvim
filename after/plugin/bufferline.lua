...
bufferline .setup {
    ...
    highlights = {
        ...
        warning_diagnostic_selected = { fg = palette.peach, bg = palette.surface0, sp = palette.peach, bold = true, italic = false },
        error = { fg = palette.red, bg = palette.base, sp = palette.red },
        error_visible = { fg = palette.red, bg = palette.base },
        error_selected = { fg = palette.red, bg = palette.surface0, sp = palette.red, bold = true, italic = false },
        error_diagnostic = { fg = palette.red, bg = palette.base, sp = palette.red },
        error_diagnostic_visible = { fg = palette.red, bg = palette.base },
        error_diagnostic_selected = { fg = palette.red, bg = palette.surface0, sp = palette.red, bold = true, italic = false },
        ...
        duplicate_selected = { fg = palette.overlay1, bg = palette.surface0, italic = false },
        duplicate_visible = { fg = palette.overlay1, bg = palette.base, italic = false },
        duplicate = { fg = palette.overlay1, bg = palette.base, italic = false },
        ...
        pick_selected = { fg = palette.mauve, bg = palette.surface0, bold = true, italic = false },
        pick_visible = { fg = palette.mauve, bg = palette.base, bold = true, italic = false },
        pick = { fg = palette.mauve, bg = palette.base, bold = true, italic = false },
